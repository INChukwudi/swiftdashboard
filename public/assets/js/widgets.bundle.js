...
//         var labelColor = KTUtil.getCssVariableValue('--bs-gray-500');
//         var borderColor = KTUtil.getCssVariableValue('--bs-border-dashed-color');
//         var baseprimaryColor = KTUtil.getCssVariableValue('--bs-danger');
//         var lightprimaryColor = KTUtil.getCssVariableValue('--bs-danger');
...
var KTChartsWidget6 = function () {
    ...
    var initChart = function(chart) {
        ...
        var options = {
            ...
            colors: ['#3E97FF', '#F1416C', '#50CD89', '#FFC700', '#7239EA'],                                                                      
            xaxis: {
                categories: ["Software Dev", "Admin", 'Customer Support', 'Sales & Business Dev', 'Management'],
                labels: {
                    formatter: function (val) {
                        return val + "Points"
                    },
